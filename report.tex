...
\usepackage[tableposition=top]{caption} %подписи к таблицам, рисункам
...
\DeclareCaptionLabelFormat{my-11figure}{Рисунок #2}
\DeclareCaptionLabelFormat{my-11table}{Таблица #2}
\DeclareCaptionLabelSeparator{my-11}{.~}
\captionsetup{labelsep=my-11}
\captionsetup[figure]{labelformat=my-11figure}
\captionsetup[table]{labelformat=my-11table}
